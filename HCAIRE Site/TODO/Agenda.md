...
### Stato: done (2026-04-19)
### Priorità: alta
### Dipendenze: nessuna

Rendere esplicito in tutto il sito l'adozione del paradigma "Agenti shift".
La scelta è illustrata in `TODO/Sezione HCAIRE/Agentic shift.md`.

Preparare le istruzioni per Claude Code per apportare le modifiche al sito:
1. Inserire nella sezione HCAIRE la pagina che illustra l'adozione del paradigma "Agenti shift" da parte del sito.
2. Predisporre la **Trasparenza** del modo di sviluppare il sito con misure del tipo:
* **Nel Footer (fisso):**
    > **Sviluppo Agentico: Questo sito è realizzato tramite processi di AI Orchestration. [Scopri di più]**.
* **Accanto a contenuti specifici (testi o moduli tecnici):**
    > *Contenuto generato tramite Agentic Workflow e revisionato da un operatore umano.*
* **Badge informativo (discreto, in alto):**
    > **Contenuti generati da Agenti AI [Scopri di più]**

Istruzioni operative per Claude Code: `TODO/Per Claude Code/001-Adozione-Agentic-Shift/istruzioni.md`
...
Il paradigma "Agenti shift" in HCAIRE è supportato da una serie di protocolli che guidano
l'interazione con gli LLM coinvolti nella ricerca ed elaborazione dei contenuti.
...
Istruzioni operative per Claude Code: `TODO/Per Claude Code/002-Sottosezione-Protocolli/istruzioni.md`

---

## Azione 003
### Nome: Sottosezione Progetti / Sviluppo Bambino / Finalità
### Stato: pronto per Claude Code (2026-04-20)
### Priorità: alta
### Dipendenze: nessuna
